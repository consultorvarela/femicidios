<?php 
	...
	if(!empty($list)){
?><div class="bDiv table-responsive p-0" >
		<table class="table align-items-center mb-0" cellspacing="0" cellpadding="0" border="0" id="flex1">
		<thead>
		...
		<?php if(!$unset_delete || !$unset_edit || !$unset_read || !empty($actions)){?>
			<td align="left" width='20%'>
				<div class='tools'>				
					...
					?>
							<a href="<?php echo $action_url; ?>" style="width:100%"  title="<?php echo $action->label?>"><?php 
								if(!empty($action->image_url))
								{
									?><p class="buttonpi" ><?php echo $action->label?></p><?php 	
								}
							?></a>		
