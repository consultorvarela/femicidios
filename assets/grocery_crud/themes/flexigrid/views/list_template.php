...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="tDiv">
		...
		<div class="tDiv3">
        	...
        	<a class="export-anchor" href="<?php echo $export_url; ?>" download>
				<div >
					<div>
						<span class="buttonpi" style="padding-top:3px;padding-bottom:3px"><?php echo $this->l('list_export');?></span>
					</div>
				</div>
            </a>
	...
	<div class="sDiv quickSearchBox" id='quickSearchBox'>
		<div class="sDiv2" style="display:flex">
            ...
            <input type="button" value="<?php echo $this->l('list_search');?>" style="margin-left:10px" class="crud_search buttonpi" id='crud_search'>
		</div>
        <div class='search-div-clear-button'>
        	<input type="button" value="<?php echo $this->l('list_clear_filtering');?>" id='search_clear' class="search_clear buttonpi">
        </div>
	</div>
	<div class="pDiv">
		<div class="pDiv2">
			...
			<div class="pGroup" style="margin-top: -5px;">
